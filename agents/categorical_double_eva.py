...
from agents import categorical_eva
from agents.categorical_eva import _apply_categorical_projection
from chainerrl.recurrent import state_kept

class CategoricalDoubleEVA(categorical_eva.CategoricalEVA):
